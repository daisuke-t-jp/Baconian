...
extension Mach {
	...
	static func hostStatics() -> HostStatics {
		...
		hostStatics.freeSize = UInt64(machHostStatics.free_count) * pageSize2
		hostStatics.activeSize = UInt64(machHostStatics.active_count) * pageSize2
		hostStatics.inactiveSize = UInt64(machHostStatics.inactive_count) * pageSize2
		hostStatics.wireSize = UInt64(machHostStatics.wire_count) * pageSize2
